...
import kotlinx.android.synthetic.main.fragment_schedule_detail_dialog.tvDetailConferenceHour
...
class ScheduleDetailDialogFragment : DialogFragment() {
    ...
    //Cargar el estilo(FullScreenDialogStyle) desde la función onCreate
